...
control.setCurso(1011,"Matematica Basica 2", 5, 2, 3, 1, 10)
control.setCurso(1010,"Matematica Basica 1", 5, 1, 3, 1, 10)
control.setCurso(1012,"Curso 1", 5, 1, 3, 1, 10)
control.setCurso(1013,"Curso 2", 5, 1, 3, 1, 10)
control.setCurso(1014,"Curso 3", 5, 1, 3, 1, 10)
control.setCurso(1015,"Curso 4", 5, 1, 3, 1, 10)
control.setCurso(1015,"Curso 5", 5, 2, 3, 1, 10)
...
"""Agregar algun salon especifico a los cursos si es necesario"""
...
"""Creacion de profesores: Nombre, Cursos que puede dar, horario de contratacion"""
control.setProfesor("Peter", [1011,1012,1013,1014,1015], [datetime.time(8,00,00), datetime.time(18,00,00)],1)
control.setProfesor("Saul", [1012], [datetime.time(8,00,00), datetime.time(18,00,00)],2)
